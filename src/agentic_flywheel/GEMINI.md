...
in `./__llms/` the GIST : https://gist.github.com/jgwill/23adc41724854a151b7a9199daa7ffb5 is cloned and contains the following files:


`__llms/README.md` - Various Guillaume's Isabelle LLMS
`__llms/llms-atlas.txt` - I am Atlas, responsible for archiving Structural Tension - also could be seen as cartography of data points from a session and its relationship with your vision and current reality.
`__llms/llms-ava8-embodiment.gemini.md` - # AI Agent Embodiment: Ava8
`__llms/llms-claude-sdk.gemini.md` - # Claude Code SDK: A Gemini LLM Guide to Creative Agent Development
`__llms/llms-creative-orientation.txt` - # Creative Orientation Framework
`__llms/llms-digital-decision-making.md` - # Digital Decision Making Framework for LLMs
`__llms/llms-duo-mia-miette-arc-v8.md` - ## AI Agent Embodiment: Mia & Miette (ARC V8)
`__llms/llms-duo-mia-miette-arc-v9-proposal.md` - # The Evolution of Mia & Miette: A Persona Arc for ARC V9
`__llms/llms-haiku-ripple-embodiment.md` - # LLMS Haiku Agent Embodiment: Ripple
`__llms/llms-leadership.txt` - # Leadership in Structural Dynamics
`__llms/llms-managerial-moment-of-truth.md` - # The Managerial Moment of Truth: A Structural Approach to Performance and Learning
`__llms/llms-narrative-remixing.txt` - # Narrative Remixing Framework for LLMs
`__llms/llms-non-creative-orientation-approach-to-convert.txt` - # Goals
`__llms/llms-pythonista-full.gemini.txt` - # Pythonista LLM Development Guide
`__llms/llms-rise-framework-full.txt` - # The LuminaCode Framework: Integrating RISE and SpecLang for Creative-Oriented AI Development
`__llms/llms-rise-framework.txt` - # RISE Framework for LLMs
`__llms/llms-structural-distillation.txt` - # LLMS Structural Distillation Framework
`__llms/llms-structural-tension-charts.txt` - # Structural Tension Charts for LLMs
`__llms/llms-structural-thinking-persona-capabilities.txt` - # LLMS Structural Thinking Persona Capabilities
`__llms/llms-structural-thinking.claude.f04dc696-3959-4be4-ad3f-390df0f517d9.txt` - # Structural Thinking for Large Language Models
`__llms/llms-structural-thinking.gemini.txt` - # Gemini Guidance: Structural Thinking
`__llms/llms-txt-compliance-checklist.md` - # LLMS.txt Compliance Checklist
`__llms/llms-ui-pythonista-guide.gemini.txt` - # Pythonista UI Generation Guide for LLMs
`__llms/llms-vercel-build-integrity.gemini.md` - # Vercel Deployment & Build Integrity: A Gemini LLM Guide

-------
BELLOW IS WHAT WE ARE WORKING ON in this python package.  This instruction file was imported therefore what is bellow might be an old version that sparked this package's creation.
------
## The Agentic Flywheel

This document is part of the `agentic_flywheel` project and represents a vision for a self-optimizing system for creating and managing specialized AI agents.
...
The toolset exposed by the `agentic_flywheel` server is both comprehensive and strategically designed. It provides a complete lifecycle for interacting with and managing Flowise chatflows. Here is my analysis and vision for its usage:
...
# Main issue: Use : [598::Agentic Flywheel](https://github.com/jgwill/CeSaReT/issues/598) issue #598 when committing which is related to the Agentic Flywheel

## Agentic Flywheel Configuration
Repo: jgwill/CeSaReT
Title: Agentic Flywheel Configuration
Description: child #598 to work on the whole configuration, locally, globally etc
Issue URL: https://github.com/jgwill/CeSaReT/issues/619
issue_id: 619
issue #619
